const CACHE="fitness-record-v1-4-14";
const ASSETS=["./","index.html","css/app.css?v=1.4.14","js/app.js?v=1.4.14","js/storage.js?v=1.4.14","js/photo.js?v=1.4.14","js/photo-store.js?v=1.4.14","js/reorder.js?v=1.4.14","js/xlsx.js?v=1.4.14","manifest.json"];
