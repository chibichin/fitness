const CACHE="fitness-record-v1-4-12";
const ASSETS=["./","index.html","css/app.css?v=1.4.12","js/app.js?v=1.4.12","js/storage.js?v=1.4.12","js/photo.js?v=1.4.12","js/photo-store.js?v=1.4.12","js/reorder.js?v=1.4.12","js/xlsx.js?v=1.4.12","manifest.json"];
